...
using WebApiJahanardRedis.Cache;
using WebApiJahanardRedis.Data;
using WebApiJahanardRedis.Model;

namespace WebApiJahanardRedis.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        private readonly ICacheServiceJahangard _cacheService;
        private static object _lock = new object();
        public ProductController(DbContextClass dbContext, ICacheServiceJahangard cacheService)
        {
